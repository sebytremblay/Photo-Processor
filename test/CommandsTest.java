...
public class CommandsTest {
  ...
  public void testMosaic() {
    ImageModel threeByTwoMosaic = CommandImpls.MOSAIC.process(this.threeByTwoImage);
    assertEquals(new Color(0,20,30), threeByTwoMosaic.colorAt(0, 0));
    assertEquals(new Color(15,30,35), threeByTwoMosaic.colorAt(0, 1));
    assertEquals(new Color(55,56,48), threeByTwoMosaic.colorAt(0, 2));
    assertEquals(new Color(45,50,45), threeByTwoMosaic.colorAt(1, 0));
    assertEquals(new Color(55,56,48), threeByTwoMosaic.colorAt(1, 1));
    assertEquals(new Color(55,56,48), threeByTwoMosaic.colorAt(1, 2));

    ImageModel twoByTwoMosaic = CommandImpls.MOSAIC.process(this.twoByTwoImage);
    assertEquals(new Color(135,88,75), twoByTwoMosaic.colorAt(0, 0));
    assertEquals(new Color(135,88,75), twoByTwoMosaic.colorAt(0, 1));
    assertEquals(new Color(70,30,50), twoByTwoMosaic.colorAt(1, 0));
    assertEquals(new Color(180,42,211), twoByTwoMosaic.colorAt(1, 1));
  }
}
