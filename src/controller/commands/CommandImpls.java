...
public class CommandImpls {
  ...
  /**
   * Command to create a mosaic of the image with 100 seeds.
   */
  public static final ImageProcessingCommand MOSAIC = new Mosaicking(100,
          new ChooseSeedsRandomly(100, new Random(571_999_2625L)));
}
